...
mod_welcome_ui <- function(id) {
  ...
  bslib::nav_panel(
    ...
    bslib::page_fluid(
      ...
      p("Scrolling in the viewport session when hovering over the desktop switches between sessions; If you ever find your browser window disappears unexpectedly, simply hover over the viewport desktop and scroll until you're back to workspace one. You can see which workspace you are in on the taskbar, at the bottom left.")
    )
  )
}
